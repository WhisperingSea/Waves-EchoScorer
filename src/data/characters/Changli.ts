            ...
            multipliers: [
                {
                    ...
                    type: "Basic",
                    skillDetailNum: [{
                        values: ["14.84%*2", "16.05%*2", "17.27%*2", "18.97%*2", "20.19%*2", "21.59%*2", "23.53%*2", "25.48%*2", "27.43%*2", "29.49%*2", "31.93%*2", "34.36%*2", "36.79%*2", "39.22%*2", "41.66%*2", "44.09%*2", "46.52%*2", "48.95%*2", "51.39%*2"]
                    }],
                    index: 1
                }, {
