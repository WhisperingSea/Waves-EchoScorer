...
export function GlacioDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Glacio DMG Bonus"
...
export function FusionDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Fusion DMG Bonus"
      ? (forteStats.stat2Value1 || 0) +
        (forteStats.stat2Value2 || 0) +
        (forteStats.stat2Value3 || 0) +
        (forteStats.stat2Value4 || 0)
...
export function ElectroDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Electro DMG Bonus"
      ? (forteStats.stat2Value1 || 0) +
        (forteStats.stat2Value2 || 0) +
        (forteStats.stat2Value3 || 0) +
        (forteStats.stat2Value4 || 0)
...
export function AeroDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Aero DMG Bonus"
      ? (forteStats.stat2Value1 || 0) +
        (forteStats.stat2Value2 || 0) +
        (forteStats.stat2Value3 || 0) +
        (forteStats.stat2Value4 || 0)
...
export function SpectroDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Spectro DMG Bonus"
      ? (forteStats.stat2Value1 || 0) +
        (forteStats.stat2Value2 || 0) +
        (forteStats.stat2Value3 || 0) +
        (forteStats.stat2Value4 || 0)
...
export function HavocDamageCalc() {
  ...
  const forteEleDamage =
    forteStats.stat2 === "Havoc DMG Bonus"
      ? (forteStats.stat2Value1 || 0) +
        (forteStats.stat2Value2 || 0) +
        (forteStats.stat2Value3 || 0) +
        (forteStats.stat2Value4 || 0)
