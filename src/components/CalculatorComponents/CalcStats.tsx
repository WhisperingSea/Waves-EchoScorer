      ...
      <div className="CalcStats-Container">
        <section className="calcStats-section">
          ...
          <div className={`calc-stats ${Element ? "" : "even-stat"}`}>
            <img
              className="stat-Icons"
              src={icon.find((i) => i.name === "Basic Attack DMG Bonus")?.icon}
            />
            <h3>Basic Attack DMG Bonus</h3>
            <h3>{BasicAttackBonusDamage}%</h3>
          </div>
          <div className="calc-stats">
            <img
              className="stat-Icons"
              src={icon.find((i) => i.name === "Heavy Attack DMG Bonus")?.icon}
            />
            <h3>Heavy Attack DMG Bonus</h3>
          ...
          <div className={`calc-stats ${Element ? "" : "even-stat"}`}>
            ...
            />
            <h3>Resonance Skill DMG Bonus</h3>
          ...
          <div className="calc-stats">
            ...
            />
            <h3>Resonance Liberation DMG Bonus</h3>
